...
/**
 * Servo motor object. There are currently two servos in this project.
 * Each servo hardware is corresponding to one Servo object. The servo
 * is controled by calling a Python script which sends PWM signals to 
