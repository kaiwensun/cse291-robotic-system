...
public class runTurtleBot {
	...
	private TurtleBotHighlevel turtlebot = new TurtleBotHighlevel("./demo_kobuki_initialisation","~/haha");
	...
	public void parse(String currLine) {
		...
		case "move":
			if (currAction.length == 1)
				...
				turtlebot.smartGoTo(Double.parseDouble(x),Double.parseDouble(y));
			}
			break;
